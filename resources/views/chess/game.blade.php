        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row gap-6 items-start justify-center">
                ...
                <div class="w-full lg:w-64 space-y-4">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 text-xs text-gray-500 dark:text-gray-400 space-y-3">
                        <div class="space-y-1">
                            <p>Partida #{{ $game->id }}</p>
                        ...
                        <div class="pt-2 border-t border-gray-200 dark:border-gray-700">
                            <form action="{{ route('chess.game.destroy', $game->id) }}" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas eliminar esta partida? Esta acción no se puede deshacer.');">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="w-full text-center text-red-600 hover:text-red-800 dark:text-red-500 dark:hover:text-red-400 font-semibold transition-colors duration-200 py-1">
                                    🗑️ Eliminar Partida
                                </button>
                            </form>
                        </div>
